  ...
  return `
    <article class="user-card" data-index="user-${id}">
        ...
        <div class="user-resouce-info">
          ...
          <div>
             <a class="user-website" href="${website}" target="_blank" rel="noopener noreferer">tiger.com</a>
          </div>
        </div>
...
// empty 카드 태그 생성하는 함수
function createEmptySVG(emptyMessage = '데이터를 불러오지 못했습니다.') {
  return `
